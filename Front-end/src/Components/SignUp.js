...
function SignUp() {
    ...
    const EMAIL_REGEX = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[@]).{8,50}$/;
    ...
    return (
        <>
                ...
                <span style={{height:"100vh", display:"flex"}}>
                    <div className="container-fluid" style={{height:"100vh", display:"flex", margin:"auto", alignItems:"center"}}>
                        ...
                        <div className="right" style={{marginLeft:"8rem"}}>
                            <h1 style={{color:"blue"}}>S'inscrire</h1>
                            ...
                            <form method='POST' onSubmit={handleSubmit} >
                                ...
                                <div class="mb-3">
                                    <label htmlFor="exampleInputEmail1" class="form-label">Nom
                                    ...
                                    <p id="uidnote" className={nameFocus && name && !validName ? "instructions" : "offscreen"} >
                                        ...
                                        Please enter 4 to 24 characters. <br/>
                                ...
                                <div class="mb-3">
                                    <label htmlFor="exampleInputPassword1" class="form-label">Password
                                        <FontAwesomeIcon icon={faCheck} className={validPwd ? "valid" : "hide"} />
                                        <FontAwesomeIcon icon={faTimes} className={validPwd || !pwd ? "hide" : "invalid"} />
                                    </label>
                                    <input style={{width:"450px"}} type="password" class="form-control" id="pwd"
                                ...
                                <div class="mb-3">
                                    <label htmlFor="exampleInputPassword1" class="form-label">Password (Confirmation) 
                                        <FontAwesomeIcon icon={faCheck} className={validMatch && matchPwd ? "valid" : "hide"} />
                                        <FontAwesomeIcon icon={faTimes} className={validMatch || !matchPwd ? "hide" : "invalid"} />
                                    </label>
                                    <input style={{width:"450px"}} type="password" class="form-control" id="pwd-confirm"
                                ...
                                <button  disabled={!validName || !validPwd || !validMatch ? true : false} class="btn btn-primary no-underline"> 
                                    <Link to="/Home" style={{color:"white", textDecoration:"none"}}></Link>S'Inscrire
                                </button>
                            </form>
                            <p>Si vous avez un compte veuillez vous <Link to="/"> Connecter</Link> </p>
                        </div>
