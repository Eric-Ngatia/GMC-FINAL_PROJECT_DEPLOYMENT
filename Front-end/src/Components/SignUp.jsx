            ...
            <div className="right" style={{marginLeft:"8rem"}}>
                ...
                <form method='POST'>
                    <div class="mb-3">
                        ...
                        <input type="name" class="form-control" id="exampleInputname" autoComplete='name'/>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input style={{width:"450px"}} type="password" class="form-control" id="exampleInputPassword1"/>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Password (Confirmation) </label>
                        <input style={{width:"450px"}} type="password" class="form-control" id="exampleInputPassword1"/>
                    </div>
                    <button  type="submit" class="btn btn-primary no-underline"> <Link to="/Home" style={{color:"white", textDecoration:"none"}}>Se connecter</Link> </button>
                </form>
